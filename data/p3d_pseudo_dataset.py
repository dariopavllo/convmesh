...
class P3dPseudoDataset(BasePseudoDataset):
    def __init__(self, args, **kwargs):
        ...
        mapping, self.n_classes = P3dPseudoDataset.get_p3d_labels()
        args.n_classes = self.n_classes
        self.classes = [mapping[f] for f in filenames]
        
        print('Loaded P3D dataset with {} images and {} classes'.format(num_images, self.n_classes))
    ...
    def _load_pseudogt(self, idx):
        ...
        return super()._load_pseudogt(self.imagenet_indices[idx])
